...
$(function () {
    ...
    $.extend({
		...
		$('body').css( 'cursor', 'url(./images/openhand.cur), auto' );
            var def = {
            ...
            _this = {
            	...
            	toggle: function(e) {
            		var o = _this.opt;
            		if (_this.on) {
			            S.css({ cursor: 'url(./images/openhand.cur), auto' }).on(o.holdEvents,'a',onPrevent).find('a').css({ cursor: 'pointer'});
                ...
                onHold: function (e) {   
					S.css({ cursor: 'url(./images/closedhand.cur), auto' });
                    _this.moment={};
				...
				S.css({ cursor: 'url(./images/openhand.cur), auto'});
                	var sm=_this.moment,
                		o=_this.opt,
